...
export function getConsumelist(data) {
	return request.get('store/product/consume/lst', data, {
		noAuth: true
	});
}
 ...
 * 嗨购-期数列表
 */
export const rangeListApi = (params,option) => request.get("hibuy/range_list", params,option);

/**
 * 嗨购-仓位列表
 */
export const positionListApi = (params,option) => request.get("hibuy/position_list", params,option);

/**
 * 嗨购-商品列表
 */
export const haigouProductListApi = (params,option) => request.get("hibuy/product_list", params,option);

/**
 * 嗨购-预约记录
 */
export const haigouReserveApi = (params,option) => request.get("hibuy/reserve_list", params,option);