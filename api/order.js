 ...
 * 团购订单
 */
export const getStageList = (params, option) => request.get("order/stage_list", params, option);


/**
 * 团购订单-兑换积分
 */
export function tradePoint(orderId) {
	return request.post("order/convert_yh/" + orderId);
}

/**
 * 兑换商品积分
 */
export function conversionShopIntegralApi(orderId) {
	return request.post("order/redeem_product_points/" + orderId);
}
 ...
 * 商品积分释放
 */
export function integralReleaseApi(orderId) {
	return request.post("order/release_commodity_points/" + orderId);
}
 ...
 * 团购订单-转为发货
 */
export function sendGoods(orderId) {
	return request.post("order/ship_order/" + orderId);
}
 ...
 * 团购订单-选择自提
 */
export const takeTheirApi = (orderId) => request.post(`order/self_withdrawal/${orderId}`);

/**
 * 兑换嗨券
 */
export function exchangeHaiQuanApi(orderId) {
	return request.post("order/exchange_hi_coupon/" + orderId);
}
