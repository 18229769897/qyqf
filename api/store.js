 ...
 * 
 */
export function getProducListApi(params, options = {}) {
	return request.get("product/spu/lst", params, {
		...options,
		noAuth: true
	});
}
 ...
 * 获取区组列表
 */
export const getBlockListApi = (params, option) => request.get("subscribe/block/list", params, option);

/**
 * 获取期数列表
 */
export const getStageApi = (params, option) => request.get("subscribe/stage/list", params, option);

/**
 * 获取期数详情
 */
export const getStageDetailApi = (params, option) => request.get("subscribe/stage/detail", params, option);
