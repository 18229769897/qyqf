		...
		<view class="multiSpecifica_container" v-for="(item, index) in multiSpecificationList" :key="index">
			<view style="background: #fff;">
				...
				<view v-if="item.more_thanFlag">
					...
					<view class="multiSpecifica_container_item">
						<view class="multiSpecifica_container_item_label flex-start">补贴（一级）</view>
						<view class="multiSpecifica_container_item_value"><input v-model="item.extension_one" type="number" placeholder="请填写商品补贴" /></view>
					</view>

					<view class="multiSpecifica_container_item">
						<view class="multiSpecifica_container_item_label flex-start">补贴（二级）</view>
						<view class="multiSpecifica_container_item_value"><input v-model="item.extension_two" type="number" placeholder="请填写商品补贴" /></view>
					</view>
				</view>
			</view>
				...
				<scroll-view :scroll-y="true" class="scrollViewCon">
					<view class="changePopup_container_content">
						...
						<view v-if="popupOpenModel">
							...
							<view class="changePopup_container_content_item">
								<view class="changePopup_container_content_item_label">补贴（一级）</view>
							...
							<view class="changePopup_container_content_item">
								<view class="changePopup_container_content_item_label">补贴（二级）</view>
