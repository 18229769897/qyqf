	...
	<view>
		<view class="header">
			...
			<view class="fx a-center header-title">
				...
				<view class="title fx fx-center fz_32 bold">积分商城</view>
			</view>
		</view>
			...
			<view class="list">
				<template v-for="item in goodsList">
					<view class="item fx a-center">
						<image src="./images/tag.png" class="tag-img" style="width: 131rpx;" mode="widthFix"></image>
...
<style lang="scss">
	...
	.btn {
		background-image: linear-gradient(to right, #fdbc6c, #ff973e);
		color: #fff;
		width: 170rpx;
		height: 52rpx;
		border-radius: 12rpx;
