<template>
	<view :class="{'tui-input__border':inputBorder,'tui-radius__fillet':isFillet}" @tap="fieldClick">
		<view class="tui-input__wrap"
			...
			<input class="tui-input__self" :class="{'tui-text__right':textRight}"
				...
				:placeholder-style="placeholderStyl" :disabled="disabled" :maxlength="maxlength" :focus="focused"
				...
				:hold-keyboard="holdKeyboard" :auto-blur="autoBlur" @focus="onFocus" @blur="onBlur" @input="onInput"
